<script>
	...
	import { userGrid, lastStrategyUsed } from '@sudoku/stores/grid';
...
<div class="flex items-center justify-end w-full">
	{#if $lastStrategyUsed}
		<div class="text-sm font-semibold text-right text-gray-700 dark:text-gray-300 mr-4">
			Strategy: <span class="text-primary">{$lastStrategyUsed}</span>
		</div>
	{/if}
